(function ($) {
  ...
  $("#download_page").on("click", function () {
    ...
    var sctipts = '<script>$(".carousel-control").on("click",function(){var s=$(this),c=$(this).closest(".carousel");return c.carousel(s.hasClass("left")?"prev":"next"),!1}),$(".carousel-indicators").find("li").on("click",function(){var s=$(this),c=s.index();return s.closest(".carousel").carousel(c),!1});</script>';
    ...
    var footer = jquerySrc + bootstrapJsSrc + sctipts + '</body></html>';
